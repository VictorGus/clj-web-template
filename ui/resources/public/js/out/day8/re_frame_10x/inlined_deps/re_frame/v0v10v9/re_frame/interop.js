...
return [(function (){var pred__10938 = cljs.core.instance_QMARK_;
var expr__10939 = reactive_val;
if(cljs.core.truth_(pred__10938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__10939))){
return "ra";
} else {
if(cljs.core.truth_(pred__10938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__10939))){
return "rc";
} else {
if(cljs.core.truth_(pred__10938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__10939))){
return "rx";
} else {
if(cljs.core.truth_(pred__10938.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__10939))){
return "tr";
} else {
return "other";
}
