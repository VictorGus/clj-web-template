...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("settings","panel-width%-rounded","settings/panel-width%-rounded",1475049191),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","panel-width%","settings/panel-width%",-1897072808)], null),(function (panel_width_PERCENT_,p__27478){
var vec__27479 = p__27478;
var _ = cljs.core.nth.call(null,vec__27479,(0),null);
var n = cljs.core.nth.call(null,vec__27479,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("settings","window-width-rounded","settings/window-width-rounded",-924202629),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","window-width","settings/window-width",640332180)], null),(function (width,p__27482){
var vec__27483 = p__27482;
var _ = cljs.core.nth.call(null,vec__27483,(0),null);
var n = cljs.core.nth.call(null,vec__27483,(1),null);
...
return cljs.core.map.call(null,(function (p1__27486_SHARP_){
return cljs.core.assoc.call(null,cljs.core.val.call(null,p1__27486_SHARP_),new cljs.core.Keyword(null,"id","id",-1388402092),cljs.core.key.call(null,p1__27486_SHARP_));
...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("traces","current-event-traces","traces/current-event-traces",1386605769),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("traces","all-traces","traces/all-traces",-755374523)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","beginning-trace-id","epochs/beginning-trace-id",-1340593887)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","ending-trace-id","epochs/ending-trace-id",-1920901579)], null),(function (p__27491,_){
var vec__27492 = p__27491;
var traces = cljs.core.nth.call(null,vec__27492,(0),null);
var beginning = cljs.core.nth.call(null,vec__27492,(1),null);
var ending = cljs.core.nth.call(null,vec__27492,(2),null);
...
day8.re_frame_10x.subs.filter_ignored_views = (function day8$re_frame_10x$subs$filter_ignored_views(p__27495,_){
var vec__27496 = p__27495;
var traces = cljs.core.nth.call(null,vec__27496,(0),null);
var filtered_views = cljs.core.nth.call(null,vec__27496,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.remove.call(null,((function (munged_ns,vec__27496,traces,filtered_views){
...
});})(munged_ns,vec__27496,traces,filtered_views))
),traces);
});
...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","current-match-state","epochs/current-match-state",-1577612281),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","epoch-root","epochs/epoch-root",-2097634597)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__27499,_){
var vec__27500 = p__27499;
var epochs = cljs.core.nth.call(null,vec__27500,(0),null);
var match_ids = cljs.core.nth.call(null,vec__27500,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","older-epochs-available?","epochs/older-epochs-available?",366051335),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__27503){
var vec__27504 = p__27503;
var current = cljs.core.nth.call(null,vec__27504,(0),null);
var ids = cljs.core.nth.call(null,vec__27504,(1),null);
return ((((1) < cljs.core.count.call(null,ids))) && ((((current == null)) || ((current > cljs.core.nth.call(null,ids,(0)))))));
}));
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("epochs","newer-epochs-available?","epochs/newer-epochs-available?",-1411103953),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","match-ids","epochs/match-ids",-669448057)], null),(function (p__27507){
var vec__27508 = p__27507;
var current = cljs.core.nth.call(null,vec__27508,(0),null);
var ids = cljs.core.nth.call(null,vec__27508,(1),null);
...
return cljs.core.filter.call(null,(function (p1__27511_SHARP_){
return ((day8.re_frame_10x.metamorphic.request_animation_frame_QMARK_.call(null,p1__27511_SHARP_)) || (day8.re_frame_10x.metamorphic.request_animation_frame_end_QMARK_.call(null,p1__27511_SHARP_)));
}),traces);
}));
...
var len__4730__auto___27518 = arguments.length;
var i__4731__auto___27519 = (0);
while(true){
if((i__4731__auto___27519 < len__4730__auto___27518)){
args_arr__4751__auto__.push((arguments[i__4731__auto___27519]));

var G__27520 = (i__4731__auto___27519 + (1));
i__4731__auto___27519 = G__27520;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.subs._PLUS_nil.cljs$lang$applyTo = (function (seq27513){
...
var map__27532 = cljs.core.get.call(null,match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
...
var event_time = cljs.core.get.call(null,map__27532__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.call(null,map__27532__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.call(null,map__27532__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.call(null,map__27532__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
...
return (!(cljs.core.empty_QMARK_.call(null,p1__27534_SHARP_)));
})], null),null);
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("subs","view-subs","subs/view-subs",253084832),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","coll-of","cljs.spec.alpha/coll-of",1019430407,null),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057)),cljs.spec.alpha.every_impl.call(null,new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.Keyword("subs","view-panel-sub","subs/view-panel-sub",-1872730057),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("cljs.spec.alpha","kind-form","cljs.spec.alpha/kind-form",-1047104697),null,new cljs.core.Keyword("cljs.spec.alpha","cpred","cljs.spec.alpha/cpred",-693471218),(function (G__27537){
return cljs.core.coll_QMARK_.call(null,G__27537);
...
var G__27540 = (exp - (1));
var G__27541 = (total + (day8.re_frame_10x.subs.sub_type_value.call(null,sub_type) * Math.pow((10),exp)));
var G__27542 = cljs.core.rest.call(null,order__$1);
exp = G__27540;
total = G__27541;
order__$1 = G__27542;
continue;
...
var G__27543 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(t);
 ...
 */
day8.re_frame_10x.subs.prepare_pod_info = (function day8$re_frame_10x$subs$prepare_pod_info(p__27545,p__27546){
var vec__27547 = p__27545;
var sub_info = cljs.core.nth.call(null,vec__27547,(0),null);
var sub_state = cljs.core.nth.call(null,vec__27547,(1),null);
var vec__27550 = p__27546;
var subscription = cljs.core.nth.call(null,vec__27550,(0),null);
var remove_fn = ((cljs.core._EQ_.call(null,subscription,new cljs.core.Keyword("subs","intra-epoch-subs","subs/intra-epoch-subs",-1298574944)))?((function (vec__27547,sub_info,sub_state,vec__27550,subscription){
return (function (me){
return (new cljs.core.Keyword(null,"order","order",-1254677256).cljs$core$IFn$_invoke$arity$1(cljs.core.val.call(null,me)) == null);
});})(vec__27547,sub_info,sub_state,vec__27550,subscription))
:cljs.core.constantly.call(null,false));
var subx = cljs.core.sort_by.call(null,new cljs.core.Keyword(null,"order","order",-1254677256),day8.re_frame_10x.subs.sub_sort_val,cljs.core.map.call(null,((function (remove_fn,vec__27547,sub_info,sub_state,vec__27550,subscription){
return (function (me){
...
return sub__$2;
});})(remove_fn,vec__27547,sub_info,sub_state,vec__27550,subscription))
...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.reg_sub.call(null,new cljs.core.Keyword("subs","visible-subs","subs/visible-subs",-1536647862),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","all-subs","subs/all-subs",1599770325)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","ignore-unchanged-l2-subs?","subs/ignore-unchanged-l2-subs?",-1438622704)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","filter-str","subs/filter-str",1975403754)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("subs","sub-pins","subs/sub-pins",1713411647)], null),(function (p__27553){
var vec__27554 = p__27553;
var all_subs = cljs.core.nth.call(null,vec__27554,(0),null);
var ignore_unchanged_l2_QMARK_ = cljs.core.nth.call(null,vec__27554,(1),null);
var filter_str = cljs.core.nth.call(null,vec__27554,(2),null);
var pins = cljs.core.nth.call(null,vec__27554,(3),null);
var compare_fn = ((function (vec__27554,all_subs,ignore_unchanged_l2_QMARK_,filter_str,pins){
...
});})(vec__27554,all_subs,ignore_unchanged_l2_QMARK_,filter_str,pins))
;
var G__27557 = cljs.core.sort.call(null,compare_fn,all_subs);
var G__27557__$1 = (cljs.core.truth_(ignore_unchanged_l2_QMARK_)?cljs.core.remove.call(null,day8.re_frame_10x.metamorphic.unchanged_l2_subscription_QMARK_,G__27557):G__27557);
if(cljs.core.truth_(cljs.core.not_empty.call(null,filter_str))){
return cljs.core.filter.call(null,((function (G__27557,G__27557__$1,compare_fn,vec__27554,all_subs,ignore_unchanged_l2_QMARK_,filter_str,pins){
...
var path = cljs.core.get.call(null,map__27559__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var id = cljs.core.get.call(null,map__27559__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
});})(G__27557,G__27557__$1,compare_fn,vec__27554,all_subs,ignore_unchanged_l2_QMARK_,filter_str,pins))
,G__27557__$1);
} else {
return G__27557__$1;
}
...
var window_width = cljs.core.nth.call(null,vec__27562,(0),null);
var char_width = cljs.core.nth.call(null,vec__27562,(1),null);
