...
if((c > n)){
var G__15023 = cut_from;
var G__15023__$1 = (((G__15023 instanceof cljs.core.Keyword))?G__15023.fqn:null);
switch (G__15023__$1) {
case "start":
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,string,(0),(function (){var G__15026 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__15023__$1)].join('')));
...
var G__15033 = clojure.string.replace.call(null,s,match,trunc_prefix);
var G__15034 = limit;
var G__15035 = match;
var G__15036 = trunc_prefix;
s = G__15033;
limit = G__15034;
match = G__15035;
trunc_prefix = G__15036;
continue;
}
}
break;
...
var prefix = (function (){var G__15037 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__15037,"\u2026/"].join('');
} else {
return G__15037;
}
})();
...
var vec__15039 = day8.re_frame_10x.utils.pretty_print_condensed.edges.call(null,coll);
var left = cljs.core.nth.call(null,vec__15039,(0),null);
var right = cljs.core.nth.call(null,vec__15039,(1),null);
...
var or__4131__auto__ = (function (){var G__15046 = form.name;
if((G__15046 == null)){
return null;
} else {
return clojure.string.replace.call(null,G__15046,/(^.*\$)(.*)/,"$2");
}
})();
...
var seq__15048 = cljs.core.seq.call(null,cljs.core.next.call(null,objs));
var chunk__15049 = null;
var count__15050 = (0);
var i__15051 = (0);
while(true){
if((i__15051 < count__15050)){
var obj = cljs.core._nth.call(null,chunk__15049,i__15051);
...
var temp__5720__auto__ = cljs.core.seq.call(null,seq__15048);
if(temp__5720__auto__){
var seq__15048__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__15048__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__15048__$1);
var G__15056 = cljs.core.chunk_rest.call(null,seq__15048__$1);
var G__15057 = c__4550__auto__;
var G__15058 = cljs.core.count.call(null,c__4550__auto__);
var G__15059 = (0);
seq__15048 = G__15056;
...
var obj = cljs.core.first.call(null,seq__15048__$1);
cljs.core._write.call(null,writer," ");
...
var len__4730__auto___15066 = arguments.length;
var i__4731__auto___15067 = (0);
while(true){
if((i__4731__auto___15067 < len__4730__auto___15066)){
args__4736__auto__.push((arguments[i__4731__auto___15067]));

var G__15068 = (i__4731__auto___15067 + (1));
i__4731__auto___15067 = G__15068;
continue;
} else {
}
break;
...
/** @this {Function} */
day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq15064){
var G__15065 = cljs.core.first.call(null,seq15064);
var seq15064__$1 = cljs.core.next.call(null,seq15064);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15065,seq15064__$1);
});
