...
var len__4730__auto___28877 = arguments.length;
var i__4731__auto___28878 = (0);
while(true){
if((i__4731__auto___28878 < len__4730__auto___28877)){
args__4736__auto__.push((arguments[i__4731__auto___28878]));

var G__28879 = (i__4731__auto___28878 + (1));
i__4731__auto___28878 = G__28879;
continue;
} else {
}
break;
...
day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__28874){
...
var model = cljs.core.get.call(null,map__28875__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.call(null,map__28875__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.call(null,map__28875__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.call(null,map__28875__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
/** @this {Function} */
day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq28873){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq28873));
});
...
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","set-number-of-retained-epochs","settings/set-number-of-retained-epochs",-1910736736),p1__28880_SHARP_], null));
...
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__28881_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__28886(s__28887){
...
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__28887__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__28889 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__28888 = (0);
while(true){
if((i__28888 < size__4522__auto__)){
var item = cljs.core._nth.call(null,c__4521__auto__,i__28888);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__28889,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__28888,id,item,c__4521__auto__,size__4522__auto__,b__28889,s__28887__$2,temp__5720__auto__){
return (function (){
...
});})(i__28888,id,item,c__4521__auto__,size__4522__auto__,b__28889,s__28887__$2,temp__5720__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28888,id,item,c__4521__auto__,size__4522__auto__,b__28889,s__28887__$2,temp__5720__auto__){
return (function (p1__28882_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__28882_SHARP_], null));
});})(i__28888,id,item,c__4521__auto__,size__4522__auto__,b__28889,s__28887__$2,temp__5720__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__28894 = (i__28888 + (1));
i__28888 = G__28894;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28889),day8$re_frame_10x$view$settings$render_$_iter__28886.call(null,cljs.core.chunk_rest.call(null,s__28887__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28889),null);
}
} else {
var item = cljs.core.first.call(null,s__28887__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__28887__$2,temp__5720__auto__){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__28887__$2,temp__5720__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__28887__$2,temp__5720__auto__){
return (function (p1__28882_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__28882_SHARP_], null));
});})(id,item,s__28887__$2,temp__5720__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__28886.call(null,cljs.core.rest.call(null,s__28887__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4523__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__28890(s__28891){
return (new cljs.core.LazySeq(null,(function (){
var s__28891__$1 = s__28891;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__28891__$1);
if(temp__5720__auto__){
var s__28891__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__28891__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__28891__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__28893 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__28892 = (0);
while(true){
if((i__28892 < size__4522__auto__)){
var item = cljs.core._nth.call(null,c__4521__auto__,i__28892);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append.call(null,b__28893,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__28892,id,item,c__4521__auto__,size__4522__auto__,b__28893,s__28891__$2,temp__5720__auto__){
return (function (){
...
});})(i__28892,id,item,c__4521__auto__,size__4522__auto__,b__28893,s__28891__$2,temp__5720__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__28892,id,item,c__4521__auto__,size__4522__auto__,b__28893,s__28891__$2,temp__5720__auto__){
return (function (p1__28883_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__28883_SHARP_], null));
});})(i__28892,id,item,c__4521__auto__,size__4522__auto__,b__28893,s__28891__$2,temp__5720__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__28895 = (i__28892 + (1));
i__28892 = G__28895;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28893),day8$re_frame_10x$view$settings$render_$_iter__28890.call(null,cljs.core.chunk_rest.call(null,s__28891__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28893),null);
}
} else {
var item = cljs.core.first.call(null,s__28891__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__28891__$2,temp__5720__auto__){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__28891__$2,temp__5720__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__28891__$2,temp__5720__auto__){
return (function (p1__28883_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__28883_SHARP_], null));
});})(id,item,s__28891__$2,temp__5720__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__28890.call(null,cljs.core.rest.call(null,s__28891__$2)));
}
} else {
return null;
}
...
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__28884_SHARP_], null));
});})(low_level_trace))
