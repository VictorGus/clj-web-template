...
var G__10901 = devtools.prefs.pref.call(null,v);
v = G__10901;
continue;
} else {
return v;
...
}catch (e10904){var _e__9683__auto__ = e10904;
return false;
}})();
...
}catch (e10908){var _e__9683__auto__ = e10908;
return false;
}})();
...
}catch (e10910){var _e__9683__auto__ = e10910;
return false;
}}
}
});
...
var vec__10912 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
...
return cljs.core.some.call(null,(function (p1__10915_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__10915_SHARP_);
}),template);
});
