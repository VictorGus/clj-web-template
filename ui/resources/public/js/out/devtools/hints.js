...
var file = cljs.core.get.call(null,map__12314__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12314__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12314__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12313){var _e = e12313;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___12316 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___12316)){
var seen_errors_12317 = temp__5718__auto___12316;
if(cljs.core.truth_(seen_errors_12317.has(self))){
} else {
seen_errors_12317.add(self);

var temp__5720__auto___12318 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___12318)){
var sense_12319 = temp__5720__auto___12318;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12319)].join('');
} else {
}
}
} else {
