...
var o10778 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10778["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10779 = temp__5718__auto____$1;
return (o10779["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9676__auto__ = f;
return (o__9676__auto__["toString"]).call(o__9676__auto__);
} else {
return "";
}
}catch (e10780){var _ = e10780;
return "";
}});
...
try{var o__9676__auto___10782 = t;
(o__9676__auto___10782["cljs$lang$ctorPrWriter"]).call(o__9676__auto___10782,t,writer);
}catch (e10781){var __10783 = e10781;
}
...
var char_code = (function (){var o__9676__auto__ = (new String(char$));
return (o__9676__auto__["charCodeAt"]).call(o__9676__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9676__auto__ = String;
return (o__9676__auto__["fromCharCode"]).call(o__9676__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10784 = num_code;
switch (G__10784) {
case (1):
return (185);
...
var o__9676__auto__ = String;
return (o__9676__auto__["fromCharCode"]).call(o__9676__auto__,superscript_code);
});
/**
...
}catch (e10786){var _e__9683__auto__ = e10786;
return false;
}})())){
...
var vec__10787 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__10787,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o10790 = temp__5718__auto__;
var temp__5718__auto____$1 = (o10790["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o10791 = temp__5718__auto____$1;
return (o10791["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___10798 = arguments.length;
var i__4731__auto___10799 = (0);
while(true){
if((i__4731__auto___10799 < len__4730__auto___10798)){
args__4736__auto__.push((arguments[i__4731__auto___10799]));

var G__10800 = (i__4731__auto___10799 + (1));
i__4731__auto___10799 = G__10800;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10794){
var vec__10795 = p__10794;
var ns_detector = cljs.core.nth.call(null,vec__10795,(0),null);
...
var G__10801 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__10802 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__10801;
remaining_tokens = G__10802;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10792){
var G__10793 = cljs.core.first.call(null,seq10792);
var seq10792__$1 = cljs.core.next.call(null,seq10792);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10793,seq10792__$1);
});
...
var vec__10806 = cljs.core.split_with.call(null,(function (p1__10805_SHARP_){
return cljs.core.not_EQ_.call(null,p1__10805_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__10806,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__10806,(1),null);
...
var vec__10812 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__10812,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__10812,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__10815 = cljs.core.rest.call(null,remaining_tokens);
var G__10816 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__10815;
name_tokens = G__10816;
continue;
} else {
...
var vec__10819 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__10819,(0),null);
var arity = cljs.core.nth.call(null,vec__10819,(1),null);
var vec__10822 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__10822,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__10822,(1),null);
var vec__10825 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__10825,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__10825,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__10825,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__10825,(3),null);
...
var vec__10831 = result;
var munged_ns = cljs.core.nth.call(null,vec__10831,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__10831,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__10831,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__10831,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__10831,(4),null);
var arity = cljs.core.nth.call(null,vec__10831,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__10835 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__10835,(0),null);
var args = cljs.core.nth.call(null,vec__10835,(1),null);
var vec__10838 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__10838,(0),null);
var name = cljs.core.nth.call(null,vec__10838,(1),null);
...
var G__10841 = (arity + (1));
var G__10842 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10843){
var vec__10844 = p__10843;
var arity = cljs.core.nth.call(null,vec__10844,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__10844,(1),null);
...
return cljs.core.get.call(null,arities,p1__10847_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__10848_SHARP_);
...
args__4736__auto__.push((arguments[i__4731__auto___10856]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10851){
var vec__10852 = p__10851;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__10852,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10849){
var G__10850 = cljs.core.first.call(null,seq10849);
var seq10849__$1 = cljs.core.next.call(null,seq10849);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10850,seq10849__$1);
});
...
var map__10860 = options;
var map__10860__$1 = (((((!((map__10860 == null))))?(((((map__10860.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10860.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10860):map__10860);
var include_ns_QMARK_ = cljs.core.get.call(null,map__10860__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__10860__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__10860__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__10860__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10861 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__10861,(0),null);
var fn_name = cljs.core.nth.call(null,vec__10861,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__10861,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__10861,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__10861,(4),null);
var arity = cljs.core.nth.call(null,vec__10861,(5),null);
...
var o__9676__auto__ = f;
return (o__9676__auto__["getBasis"]).call(o__9676__auto__);
});
/**
...
}catch (e10865){var _e__9683__auto__ = e10865;
...
var G__10866 = (obj[cljs.core.first.call(null,path)]);
var G__10867 = cljs.core.rest.call(null,path);
obj = G__10866;
path = G__10867;
continue;
} else {
...
return (function (accum,p__10868){
var vec__10869 = p__10868;
var bit = cljs.core.nth.call(null,vec__10869,(0),null);
var protocol = cljs.core.nth.call(null,vec__10869,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10872){
var vec__10873 = p__10872;
var ns = cljs.core.nth.call(null,vec__10873,(0),null);
var name = cljs.core.nth.call(null,vec__10873,(1),null);
var selector = cljs.core.nth.call(null,vec__10873,(2),null);
...
return (function (p__10877){
var vec__10878 = p__10877;
var munged_name = cljs.core.nth.call(null,vec__10878,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__10878,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__10878,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10876_SHARP_){
return (obj[cljs.core.first.call(null,p1__10876_SHARP_)]);
});})(name,sorted_matches,vec__10878,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
