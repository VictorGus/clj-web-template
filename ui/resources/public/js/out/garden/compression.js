 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__17472){
var vec__17473 = p__17472;
var tag = cljs.core.nth.call(null,vec__17473,(0),null);
var re = cljs.core.nth.call(null,vec__17473,(1),null);
return ((function (vec__17473,tag,re){
return (function (s){
...
var len__4730__auto___17478 = arguments.length;
var i__4731__auto___17479 = (0);
while(true){
if((i__4731__auto___17479 < len__4730__auto___17478)){
args__4736__auto__.push((arguments[i__4731__auto___17479]));

var G__17480 = (i__4731__auto___17479 + (1));
i__4731__auto___17479 = G__17480;
continue;
} else {
}
break;
...
return p1__17476_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq17477){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq17477));
});
...
var map__17481 = temp__5718__auto__;
...
var tag = cljs.core.get.call(null,map__17481__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__17481__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__17481__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__17485 = cljs.core.subs.call(null,s1,size);
var G__17486 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__17484 = tag;
