...
return [(function (){var pred__11961 = cljs.core.instance_QMARK_;
var expr__11962 = reactive_val;
if(cljs.core.truth_(pred__11961.call(null,reagent.ratom.RAtom,expr__11962))){
return "ra";
} else {
if(cljs.core.truth_(pred__11961.call(null,reagent.ratom.RCursor,expr__11962))){
return "rc";
} else {
if(cljs.core.truth_(pred__11961.call(null,reagent.ratom.Reaction,expr__11962))){
return "rx";
} else {
if(cljs.core.truth_(pred__11961.call(null,reagent.ratom.Track,expr__11962))){
return "tr";
} else {
return "other";
}
