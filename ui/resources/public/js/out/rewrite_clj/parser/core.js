...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__24269_SHARP_){
var _STAR_delimiter_STAR__orig_val__24270 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__24271 = delimiter;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__24271;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__24269_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__24270;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4736__auto__ = [];
var len__4730__auto___24280 = arguments.length;
var i__4731__auto___24281 = (0);
while(true){
if((i__4731__auto___24281 < len__4730__auto___24280)){
args__4736__auto__.push((arguments[i__4731__auto___24281]));

var G__24282 = (i__4731__auto___24281 + (1));
i__4731__auto___24281 = G__24282;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__24276){
var vec__24277 = p__24276;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__24277,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq24272){
...
var G__24275 = cljs.core.first.call(null,seq24272__$2);
var seq24272__$3 = cljs.core.next.call(null,seq24272__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24273,G__24274,G__24275,seq24272__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__24283 = rewrite_clj.reader.peek.call(null,reader);
switch (G__24283) {
case "(":
...
var G__24285 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__24285)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"\"",G__24285)){
...
if(cljs.core._EQ_.call(null,"_",G__24285)){
