...
if((c === "\n")){
var G__24244 = escape_QMARK_;
var G__24245 = rewrite_clj.parser.string.flush_into.call(null,lines,buf);
escape_QMARK_ = G__24244;
lines = G__24245;
continue;
} else {
buf.append(c);

var G__24246 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__24247 = lines;
escape_QMARK_ = G__24246;
lines = G__24247;
continue;
