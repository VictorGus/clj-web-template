...
return clojure.zip.edit.call(null,zloc,rewrite_clj.zip.editz.edit_node,(function (p1__24510_SHARP_){
return cljs.core.apply.call(null,f,p1__24510_SHARP_,args);
}));
});
...
/** @this {Function} */
rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq24511){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24512,G__24513,seq24511__$2);
});
...
var G__24519 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__24519__$1 = (((G__24519 instanceof cljs.core.Keyword))?G__24519.fqn:null);
switch (G__24519__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__24519,G__24519__$1){
return (function (p1__24517_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24517_SHARP_)].join('');
});})(G__24519,G__24519__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__24519,G__24519__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
return cljs.core.update_in.call(null,lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),((function (G__24519,G__24519__$1){
return (function (p1__24518_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24518_SHARP_)].join('');
});})(G__24519,G__24519__$1))
);
}
});})(G__24519,G__24519__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24519__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__24522 = rewrite_clj.zip.base.tag.call(null,zloc);
var G__24522__$1 = (((G__24522 instanceof cljs.core.Keyword))?G__24522.fqn:null);
switch (G__24522__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token.call(null,zloc,((function (G__24522,G__24522__$1){
return (function (p1__24521_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24521_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
});})(G__24522,G__24522__$1))
);

break;
case "multi-line":
return rewrite_clj.zip.editz.edit_multi_line.call(null,zloc,((function (G__24522,G__24522__$1){
return (function (lines){
if(cljs.core.empty_QMARK_.call(null,lines)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [s], null);
} else {
