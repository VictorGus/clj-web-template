...
var _PERCENT_ = rewrite_clj.zip.whitespace.skip_whitespace.call(null,clojure.zip.prev,clojure.zip.remove.call(null,rewrite_clj.zip.removez.remove_trailing_space.call(null,((((rewrite_clj.zip.move.rightmost_QMARK_.call(null,zloc)) || (rewrite_clj.zip.move.leftmost_QMARK_.call(null,zloc))))?rewrite_clj.zip.removez.remove_preceding_space.call(null,zloc,(function (p1__24360_SHARP_){
var and__4120__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_.call(null,p1__24360_SHARP_);
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.not.call(null,rewrite_clj.zip.whitespace.linebreak_QMARK_.call(null,p1__24360_SHARP_));
} else {
return and__4120__auto__;
}
})):zloc),(function (p1__24361_SHARP_){
var and__4120__auto__ = rewrite_clj.zip.whitespace.whitespace_QMARK_.call(null,p1__24361_SHARP_);
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.not.call(null,rewrite_clj.zip.whitespace.linebreak_QMARK_.call(null,p1__24361_SHARP_));
} else {
return and__4120__auto__;
}
}))));
