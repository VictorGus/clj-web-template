...
var vec__27023 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper.call(null,options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__27026 = zprint.zutil.find_root_and_path_nw.call(null,coll);
var root = cljs.core.nth.call(null,vec__27026,(0),null);
var path = cljs.core.nth.call(null,vec__27026,(1),null);
...
var input = cljs.core.nth.call(null,vec__27023,(0),null);
var options__$1 = cljs.core.nth.call(null,vec__27023,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__27029){
var vec__27030 = p__27029;
var width_or_options = cljs.core.nth.call(null,vec__27030,(0),null);
var options = cljs.core.nth.call(null,vec__27030,(1),null);
...
var vec__27036 = zprint.config.perform_remove.call(null,null,null,zprint.config.get_options.call(null),rest_options);
var internal_map = cljs.core.nth.call(null,vec__27036,(0),null);
var rest_options__$1 = cljs.core.nth.call(null,vec__27036,(1),null);
var _ = cljs.core.nth.call(null,vec__27036,(2),null);
var vec__27039 = zprint.config.apply_style.call(null,null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.call(null,vec__27039,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__27039,(1),null);
var style_errors = cljs.core.nth.call(null,vec__27039,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__27044){
var vec__27045 = p__27044;
var start = cljs.core.nth.call(null,vec__27045,(0),null);
var end = cljs.core.nth.call(null,vec__27045,(1),null);
...
var vec__27051 = zprint.core.process_rest_options.call(null,internal_options,rest);
var special_option = cljs.core.nth.call(null,vec__27051,(0),null);
var rest_options = cljs.core.nth.call(null,vec__27051,(1),null);
...
var vec__27054 = zprint.core.zprint_STAR_.call(null,coll,special_option,actual_options);
var cvec = cljs.core.nth.call(null,vec__27054,(0),null);
var options = cljs.core.nth.call(null,vec__27054,(1),null);
...
/** @this {Function} */
zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq27048){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27049,G__27050,seq27048__$2);
});
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq27062){
var G__27063 = cljs.core.first.call(null,seq27062);
var seq27062__$1 = cljs.core.next.call(null,seq27062);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27063,seq27062__$1);
});
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq27067){
var G__27068 = cljs.core.first.call(null,seq27067);
var seq27067__$1 = cljs.core.next.call(null,seq27067);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27068,seq27067__$1);
});
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq27072){
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq27077){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__27083,form){
var vec__27084 = p__27083;
var next_options = cljs.core.nth.call(null,vec__27084,(0),null);
var _ = cljs.core.nth.call(null,vec__27084,(1),null);
var indent = cljs.core.nth.call(null,vec__27084,(2),null);
var zprint_num = cljs.core.nth.call(null,vec__27084,(3),null);
...
var vec__27087 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.call(null,vec__27087,(0),null);
var error_str = cljs.core.nth.call(null,vec__27087,(1),null);
