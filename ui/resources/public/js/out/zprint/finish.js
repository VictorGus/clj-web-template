...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__18878_SHARP_){
if(cljs.core.not_EQ_.call(null,p1__18878_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__18878_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__18879){
var vec__18880 = p__18879;
var low = cljs.core.nth.call(null,vec__18880,(0),null);
var high = cljs.core.nth.call(null,vec__18880,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__18883,s,color,element,idx){
...
var style_map = cljs.core.get.call(null,map__18884__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.call(null,map__18884__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.call(null,map__18884__$1,new cljs.core.Keyword(null,"select","select",1147833503));
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__18886){
var vec__18887 = p__18886;
var s = cljs.core.nth.call(null,vec__18887,(0),null);
var style = cljs.core.nth.call(null,vec__18887,(1),null);
var start = cljs.core.nth.call(null,vec__18887,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__18890){
var vec__18891 = p__18890;
var s = cljs.core.nth.call(null,vec__18891,(0),null);
var keyword_color = cljs.core.nth.call(null,vec__18891,(1),null);
var element = cljs.core.nth.call(null,vec__18891,(2),null);
...
var G__18894 = cljs.core.next.call(null,ssv);
var G__18895 = (this_ssv == null);
var G__18896 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__18897 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.call(null,cljs.core.conj.call(null,cljs.core.conj.call(null,out,zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec.call(null,ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.call(null,out,this_ssv)
)));
ssv = G__18894;
doing_nil_QMARK_ = G__18895;
last_elide = G__18896;
out = G__18897;
continue;
}
...
var vec__18901 = cljs.core.first.call(null,remaining_cvec);
var _ = cljs.core.nth.call(null,vec__18901,(0),null);
var ___$1 = cljs.core.nth.call(null,vec__18901,(1),null);
var element_type = cljs.core.nth.call(null,vec__18901,(2),null);
...
var G__18904 = cljs.core.next.call(null,remaining_cvec);
var G__18905 = new_idx;
var G__18906 = cljs.core.conj.call(null,out,new_idx);
remaining_cvec = G__18904;
idx = G__18905;
out = G__18906;
continue;
}
...
var G__18913 = cljs.core.next.call(null,ss_vec);
...
var G__18915 = (pos + cljs.core.count.call(null,cljs.core.first.call(null,ss)));
var G__18916 = ((((same_style_QMARK_) || (cljs.core._EQ_.call(null,initial_pos,pos))))?out:cljs.core.conj.call(null,out,zprint.finish.add_length.call(null,current)));
ss_vec = G__18913;
current = G__18914;
pos = G__18915;
out = G__18916;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__18917,cursor_vec){
var vec__18918 = p__18917;
var focus_start = cljs.core.nth.call(null,vec__18918,(0),null);
var focus_end = cljs.core.nth.call(null,vec__18918,(1),null);
var focus_vec = vec__18918;
...
var vec__18921 = cljs.core.split_at.call(null,focus_start,gcw_vec);
var front = cljs.core.nth.call(null,vec__18921,(0),null);
var back = cljs.core.nth.call(null,vec__18921,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__18924){
var vec__18925 = p__18924;
var s = cljs.core.nth.call(null,vec__18925,(0),null);
var color = cljs.core.nth.call(null,vec__18925,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__18931,existing_count){
var vec__18932 = p__18931;
var s = cljs.core.nth.call(null,vec__18932,(0),null);
var cursor = cljs.core.nth.call(null,vec__18932,(1),null);
...
return cljs.core.filterv.call(null,((function (s__$1,len,cursor__$1,vec__18932,s,cursor){
return (function (p1__18928_SHARP_){
return (!(cljs.core.empty_QMARK_.call(null,cljs.core.first.call(null,p1__18928_SHARP_))));
});})(s__$1,len,cursor__$1,vec__18932,s,cursor))
...
var vec__18939 = cljs.core.first.call(null,cvec_nl);
var n = cljs.core.nth.call(null,vec__18939,(0),null);
var where = cljs.core.nth.call(null,vec__18939,(1),null);
var cvec_element = vec__18939;
if((cvec_element == null)){
var G__18942 = cljs.core.next.call(null,cvec_nl);
var G__18943 = (idx + (1));
var G__18944 = start;
var G__18945 = out;
cvec_nl = G__18942;
...
var G__18946 = cljs.core.next.call(null,cvec_nl);
var G__18947 = (idx + (1));
var G__18948 = idx;
var G__18949 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__18946;
idx = G__18947;
start = G__18948;
out = G__18949;
...
var G__18950 = cljs.core.next.call(null,cvec_nl);
var G__18951 = (idx + (1));
var G__18952 = (idx + (1));
var G__18953 = cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__18950;
idx = G__18951;
start = G__18952;
out = G__18953;
...
var G__18954 = cljs.core.next.call(null,cvec_nl);
var G__18955 = (idx + (1));
var G__18956 = idx;
var G__18957 = cljs.core.apply.call(null,cljs.core.conj,cljs.core.conj.call(null,out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__18954;
idx = G__18955;
start = G__18956;
out = G__18957;
...
var G__18958 = cljs.core.next.call(null,cvec_nl);
var G__18959 = (idx + (1));
var G__18960 = start;
var G__18961 = cljs.core.apply.call(null,cljs.core.conj,out,cljs.core.repeat.call(null,n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__18958;
idx = G__18959;
start = G__18960;
out = G__18961;
...
return cljs.core.reduce.call(null,(function (p1__18963_SHARP_,p2__18962_SHARP_){
if(zprint.finish.within_QMARK_.call(null,idx,p2__18962_SHARP_)){
return cljs.core.reduced.call(null,p1__18963_SHARP_);
} else {
return (p1__18963_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__18964,p__18965){
var vec__18966 = p__18964;
var focus_begin = cljs.core.nth.call(null,vec__18966,(0),null);
var focus_end = cljs.core.nth.call(null,vec__18966,(1),null);
var vec__18969 = p__18965;
var before = cljs.core.nth.call(null,vec__18969,(0),null);
var after = cljs.core.nth.call(null,vec__18969,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__18973,cvec,focus_vec){
...
var map__18975 = cljs.core.get.call(null,map__18974__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.call(null,map__18975__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.call(null,map__18975__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.call(null,map__18975__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.call(null,((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__18974,map__18974__$1,options,map__18975,map__18975__$1,focus,lines,paths){
return (function (p1__18972_SHARP_){
return zprint.finish.surround_focus.call(null,lines_to_cvec,p1__18972_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__18974,map__18974__$1,options,map__18975,map__18975__$1,focus,lines,paths))
,path_vecs);
