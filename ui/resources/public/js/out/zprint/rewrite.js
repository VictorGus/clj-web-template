...
var G__24989 = rewrite_clj.zip.next.call(null,n);
loc = G__24989;
continue;
} else {
var G__24990 = rewrite_clj.zip.next.call(null,loc);
loc = G__24990;
continue;
}
} else {
var G__24991 = rewrite_clj.zip.next.call(null,loc);
loc = G__24991;
continue;
}
}
...
return rewrite_clj.zip.replace.call(null,zloc,rewrite_clj.zip.root.call(null,zprint.rewrite.prewalk_subtree.call(null,p_QMARK_,f,(function (){var G__24992 = zloc;
var G__24992__$1 = (((G__24992 == null))?null:rewrite_clj.zip.node.call(null,G__24992));
if((G__24992__$1 == null)){
return null;
} else {
return zprint.zutil.edn_STAR_.call(null,G__24992__$1);
}
})())));
});
/**
...
var G__24993 = rewrite_clj.zip.down.call(null,nloc);
nloc = G__24993;
continue;
}
break;
...
var G__24994 = rewrite_clj.zip.right.call(null,nloc);
var G__24995 = cljs.core.conj.call(null,out,nloc);
nloc = G__24994;
out = G__24995;
continue;
} else {
...
var G__24996 = rewrite_clj.zip.right.call(null,replaced_loc);
var G__24997 = cljs.core.next.call(null,new_loc);
var G__24998 = replaced_loc;
nloc = G__24996;
new_loc = G__24997;
last_loc = G__24998;
continue;
...
var new_dep = zprint.rewrite.prewalk.call(null,zloc,(function (p1__24999_SHARP_){
return ((cljs.core._EQ_.call(null,rewrite_clj.zip.tag.call(null,p1__24999_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.call(null,rewrite_clj.zip.sexpr.call(null,p1__24999_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
